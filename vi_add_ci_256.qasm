...
:loop
	...
	alu.add, vpm_write, ra1, rb0
	alu.add, vpm_write, ra2, rb0
	alu.add, vpm_write, ra3, rb0
	alu.add, vpm_write, ra4, rb0
	alu.add, vpm_write, ra5, rb0
	alu.add, vpm_write, ra6, rb0
	alu.add, vpm_write, ra7, rb0
	alu.add, vpm_write, ra8, rb0
	alu.add, vpm_write, ra9, rb0
	alu.add, vpm_write, ra10, rb0
	alu.add, vpm_write, ra11, rb0
	alu.add, vpm_write, ra12, rb0
	alu.add, vpm_write, ra13, rb0
	alu.add, vpm_write, ra14, rb0
	alu.add, vpm_write, ra15, rb0
